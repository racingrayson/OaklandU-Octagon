...
"""autogenerated by genpy from ublox_msgs/NavRELPOSNED9.msg. Do not edit."""
import codecs
import sys
...
class NavRELPOSNED9(genpy.Message):
  _md5sum = "5acd7899c1f1094e1680da583d0ff1f9"
  _type = "ublox_msgs/NavRELPOSNED9"
...
uint32 FLAGS_REL_POS_NORM = 512   # Set if extrapolated reference observations
  ...
  __slots__ = ['version','reserved1','refStationId','iTOW','relPosN','relPosE','relPosD','relPosLength','relPosHeading','reserved2','relPosHPN','relPosHPE','relPosHPD','relPosHPLength','accN','accE','accD','accLength','accHeading','reserved3','flags']
  _slot_types = ['uint8','uint8','uint16','uint32','int32','int32','int32','int32','int32','uint8[4]','int8','int8','int8','int8','uint32','uint32','uint32','uint32','uint32','uint8[4]','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       version,reserved1,refStationId,iTOW,relPosN,relPosE,relPosD,relPosLength,relPosHeading,reserved2,relPosHPN,relPosHPE,relPosHPD,relPosHPLength,accN,accE,accD,accLength,accHeading,reserved3,flags
    ...
    """
    if args or kwds:
      super(NavRELPOSNED9, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2BHI5i().pack(_x.version, _x.reserved1, _x.refStationId, _x.iTOW, _x.relPosN, _x.relPosE, _x.relPosD, _x.relPosLength, _x.relPosHeading))
      _x = self.reserved2
      ...
      _x = self
      buff.write(_get_struct_4b5I().pack(_x.relPosHPN, _x.relPosHPE, _x.relPosHPD, _x.relPosHPLength, _x.accN, _x.accE, _x.accD, _x.accLength, _x.accHeading))
      _x = self.reserved3
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_4B().pack(*_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.version, _x.reserved1, _x.refStationId, _x.iTOW, _x.relPosN, _x.relPosE, _x.relPosD, _x.relPosLength, _x.relPosHeading,) = _get_struct_2BHI5i().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.relPosHPN, _x.relPosHPE, _x.relPosHPD, _x.relPosHPLength, _x.accN, _x.accE, _x.accD, _x.accLength, _x.accHeading,) = _get_struct_4b5I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2BHI5i = None
def _get_struct_2BHI5i():
    global _struct_2BHI5i
    if _struct_2BHI5i is None:
        _struct_2BHI5i = struct.Struct("<2BHI5i")
    return _struct_2BHI5i
_struct_4B = None
def _get_struct_4B():
    global _struct_4B
    ...
    return _struct_4B
_struct_4b5I = None
def _get_struct_4b5I():
    global _struct_4b5I
    if _struct_4b5I is None:
        _struct_4b5I = struct.Struct("<4b5I")
    return _struct_4b5I
_struct_4s = None
def _get_struct_4s():
    global _struct_4s
