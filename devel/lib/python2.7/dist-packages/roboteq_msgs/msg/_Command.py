...
"""autogenerated by genpy from roboteq_msgs/Command.msg. Do not edit."""
import codecs
import sys
...
class Command(genpy.Message):
  _md5sum = "9f57e6568807eb250db6d5bd382ee299"
  _type = "roboteq_msgs/Command"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_bf().pack(_x.mode, _x.setpoint))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.setpoint,) = _get_struct_bf().unpack(str[start:end])
      return self
