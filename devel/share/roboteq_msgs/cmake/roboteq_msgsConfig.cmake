...
if("TRUE" STREQUAL "TRUE")
  set(roboteq_msgs_SOURCE_PREFIX /home/joe/octagon/src/roboteq_msgs)
  set(roboteq_msgs_DEVEL_PREFIX /home/joe/octagon/devel)
  ...
  set(roboteq_msgs_INSTALL_PREFIX /home/joe/octagon/install)
...
if(NOT "/home/joe/octagon/devel/include " STREQUAL " ")
  set(roboteq_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/joe/octagon/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joe/octagon/src/roboteq_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT roboteq_msgs_NUM_DUMMY_TARGETS)
      set(roboteq_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::roboteq_msgs::wrapped-linker-option${roboteq_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR roboteq_msgs_NUM_DUMMY_TARGETS "${roboteq_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::roboteq_msgs::wrapped-linker-option${roboteq_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND roboteq_msgs_LIBRARIES "${interface_target_name}")
